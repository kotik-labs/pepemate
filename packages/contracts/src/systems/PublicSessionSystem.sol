...
// import {
//     Player, Position, SessionPlayers, Map, SessionMap, Session, EntityMatch, TileLookup
...
contract PublicSessionSystem is System {
    ...
    //     require(EntityMatch.get(entity).isEmpty(), "Player already in-game");
    ...
    //     EntityMatch.set(entity, session);
    //     LibTick.update(entity, 0);
    // }

    // function leavePublic() public {
    //     Entity entity = LibPlayer.entityKey(_msgSender());
    //     Entity session = EntityMatch.get(entity);
    ...
    //     EntityMatch.deleteRecord(entity);
