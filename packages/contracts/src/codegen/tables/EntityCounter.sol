...
library EntityCounter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "EntityCounter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d617465000000000000456e74697479436f756e746572000000);
   ...
   * @notice Get count.
   */
  function getCount() internal view returns (uint32 count) {
   ...
   * @notice Get count.
   */
  function _getCount() internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get count.
   */
  function get() internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Get count.
   */
  function _get() internal view returns (uint32 count) {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set count.
   */
  function setCount(uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set count.
   */
  function _setCount(uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set count.
   */
  function set(uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
   ...
   * @notice Set count.
   */
  function _set(uint32 count) internal {
    bytes32[] memory _keyTuple = new bytes32[](0);
