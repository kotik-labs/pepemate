...
library DetonateAt {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "DetonateAt", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d6174650000000000004465746f6e6174654174000000000000);
