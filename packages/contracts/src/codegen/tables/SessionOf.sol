...
library SessionOf {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "SessionOf", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d61746500000000000053657373696f6e4f6600000000000000);
