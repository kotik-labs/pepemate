...
library SessionPlayers {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "SessionPlayers", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d61746500000000000053657373696f6e506c61796572730000);
   ...
   * @notice Get players.
   */
  function getPlayers(Entity id) internal view returns (bytes32[4] memory players) {
   ...
   * @notice Get players.
   */
  function _getPlayers(Entity id) internal view returns (bytes32[4] memory players) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get players.
   */
  function get(Entity id) internal view returns (bytes32[4] memory players) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get players.
   */
  function _get(Entity id) internal view returns (bytes32[4] memory players) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set players.
   */
  function setPlayers(Entity id, bytes32[4] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set players.
   */
  function _setPlayers(Entity id, bytes32[4] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set players.
   */
  function set(Entity id, bytes32[4] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set players.
   */
  function _set(Entity id, bytes32[4] memory players) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function getItemPlayers(Entity id, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemPlayers(Entity id, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItem(Entity id, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItem(Entity id, uint256 _index) internal view returns (bytes32) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function updatePlayers(Entity id, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Update an element of players at `_index`.
   */
  function _updatePlayers(Entity id, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Update an element of players at `_index`.
   */
  function update(Entity id, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Update an element of players at `_index`.
   */
  function _update(Entity id, uint256 _index, bytes32 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
