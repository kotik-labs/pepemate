...
import { SessionStatus } from "../common.sol";
...
library SessionState {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "SessionState", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d61746500000000000053657373696f6e537461746500000000);
  ...
  // Hex-encoded value schema of (uint8, uint8, uint32[], bytes)
  Schema constant _valueSchema = Schema.wrap(0x00020202000065c4000000000000000000000000000000000000000000000000);
   ...
   * @notice Get status.
   */
  function getStatus(Entity id) internal view returns (SessionStatus status) {
   ...
   * @notice Get status.
   */
  function _getStatus(Entity id) internal view returns (SessionStatus status) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set status.
   */
  function setStatus(Entity id, SessionStatus status) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set status.
   */
  function _setStatus(Entity id, SessionStatus status) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function getPlayerBitmap(Entity id) internal view returns (uint8 playerBitmap) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get playerBitmap.
   */
  function _getPlayerBitmap(Entity id) internal view returns (uint8 playerBitmap) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function setPlayerBitmap(Entity id, uint8 playerBitmap) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);

    StoreSwitch.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((playerBitmap)), _fieldLayout);
  }

  /**
   * @notice Set playerBitmap.
   */
  function _setPlayerBitmap(Entity id, uint8 playerBitmap) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);

    StoreCore.setStaticField(_tableId, _keyTuple, 1, abi.encodePacked((playerBitmap)), _fieldLayout);
  }
   ...
   * @notice Get map.
   */
  function getMap(Entity id) internal view returns (bytes memory map) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get map.
   */
  function _getMap(Entity id) internal view returns (bytes memory map) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set map.
   */
  function setMap(Entity id, bytes memory map) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Set map.
   */
  function _setMap(Entity id, bytes memory map) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function lengthMap(Entity id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get the length of map.
   */
  function _lengthMap(Entity id) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function getItemMap(Entity id, uint256 _index) internal view returns (bytes memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @dev Reverts with Store_IndexOutOfBounds if `_index` is out of bounds for the array.
   */
  function _getItemMap(Entity id, uint256 _index) internal view returns (bytes memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function pushMap(Entity id, bytes memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Push a slice to map.
   */
  function _pushMap(Entity id, bytes memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function popMap(Entity id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Pop a slice from map.
   */
  function _popMap(Entity id) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function updateMap(Entity id, uint256 _index, bytes memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Update a slice of map at `_index`.
   */
  function _updateMap(Entity id, uint256 _index, bytes memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   */
  function get(Entity id) internal view returns (SessionStateData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
   ...
   * @notice Get the full data.
   */
  function _get(Entity id) internal view returns (SessionStateData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = Entity.unwrap(id);
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(status, playerBitmap);
   ...
   */
  function set(Entity id, SessionStateData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.status, _table.playerBitmap);
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(Entity id, SessionStateData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.status, _table.playerBitmap);
   ...
   */
  function decodeStatic(bytes memory _blob) internal pure returns (SessionStatus status, uint8 playerBitmap) {
    status = SessionStatus(uint8(Bytes.getBytes1(_blob, 0)));

    playerBitmap = (uint8(Bytes.getBytes1(_blob, 1)));
  }
  ...
  ) internal pure returns (SessionStateData memory _table) {
    (_table.status, _table.playerBitmap) = decodeStatic(_staticData);
   ...
   */
  function encodeStatic(SessionStatus status, uint8 playerBitmap) internal pure returns (bytes memory) {
    return abi.encodePacked(status, playerBitmap);
  }
