...
library TileLookup {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "pepemate", name: "TileLookup", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462706570656d61746500000000000054696c654c6f6f6b7570000000000000);
